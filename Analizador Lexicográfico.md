Parte de un [[Compilador]], cuya tarea es leer los caracteres de entrada y generar a partir de ellos [[Token|tokens]] que serán luego utilizados en el [[Análisis Sintáctico]]. 
