La BNF es una notación natural para describir sintaxis. Al igual que con [[Gramáticas Libres del Contexto - GLC|gramáticas]] se utilizan las mismas componentes:
