...
- La [[La unión de dos lenguajes Recursivos es Recursivo|construcción similar para lenguajes recursivos]] no es válida para [[Recursivamente Enumerable|lenguajes R.E]].
