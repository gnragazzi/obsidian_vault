...
![[Pasted image 20251105215212.png]]
...
2. Determinar que no existe ninguna cadena x en $\Sigma^*$ tal que $x \in L(M)$
	1. Deberían generarse cadenas siguiendo el orden canónio hasta que:  
...
Por el [[Lema de Pumping para Lenguajes Regulares (Teorema)|lema de pumping]] se sabe que esto está acotado por la cantidad de estados $|x|<|Q_M|$ ![[Pasted image 20251105215030.png]]
